 ...
 * Generated for Laravel 5.1.41 (LTS) on 2016-08-19.
 *
...
namespace {
    ...
    class Sms extends \Softon\Sms\Facades\Sms{
         ...
         * @static 
         */
        public static function send($mobile, $view, $params = array()){
            return \Softon\Sms\Sms::send($mobile, $view, $params);
        }
         ...
         * @static 
         */
        public static function send_raw($mobile, $message){
            return \Softon\Sms\Sms::send_raw($mobile, $message);
        }
