        ...
        <div id="successPullOutDeceased" class="modal modal-fixed-footer" style="overflow-y: hidden;">
            ...
            <div class="modal-footer">
                <button ng-click="generateReceipt(pullDeceasedTransaction.transactionDeceased.intTransactionDeceasedId)" name = "action" class="waves-light btn light-green" style = "color: #000000;margin-left: 15px; margin-right: 15px">Print Receipt</button>
            </div>
        </div>
        <!-- Pull Out Deceased -->
