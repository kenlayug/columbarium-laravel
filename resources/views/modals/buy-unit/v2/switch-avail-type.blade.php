...
<div id="switch" class="modal modal-fixed-footer" style="width:95%; max-height: 120%; overflow-y: hidden">
    ...
    <div class="modal-content" style="color: #000000; overflow-y: auto;">
        ...
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    <li class="tab col s3"><a class="active orange-text" href="#payOnce">Pay Once</a></li>
                    <li class="tab col s3"><a class="orange-text" href="#atNeed">At Need</a></li>
                </ul>
            </div>
            <div id="payOnce" class="col s12"><br>
            ...
            <div id="atNeed" class="col s12"><br>
