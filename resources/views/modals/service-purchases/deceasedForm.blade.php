<div id="deceasedForm" class="modal modal-fixed-footer" style="overflow-y: hidden; height: 300px;">
    <div class="modal-header" style="background-color: #00897b;">
        <center><h4 style = "font-size: 20px; color: white; padding: 20px;">Deceased Form</h4></center>
    ...
    <form ng-submit='addDeceasedToService()' autocomplete="off">
        <div class="modal-content" style="overflow-y: auto; clear: bottom;">
            <div class="row">
                ...
                <div class="col s5">
                    <a data-target="newDeceased" tooltipped class="waves-light btn light-green modal-trigger btn" data-delay="50" data-tooltip="Add New Deceased" href="#newDeceased" style="color: #000000; margin-top: 15px;"><i class="material-icons">add</i><i class="material-icons">assignment_ind</i></a>
                </div>
            </div>
