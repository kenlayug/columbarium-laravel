<div id="editCart" class="modal modal-fixed-footer" style="overflow-y: hidden; height: 350px;">
    <div class="modal-header" style="padding: 0px">
        <center><h4 style = "font-size: 20px;font-family: myFirstFont; color: white; padding: 20px;">Edit Cart</h4></center>
    </div>
    <div class="modal-content" >
        <div class="row" style="margin-top: -10px">
			...
			<div class="col s6">
                <label style="color: #000000; font-size: 15px;"><u>Metalic Urn</u></label>
            </div>
        </div>
        <div class="row">
