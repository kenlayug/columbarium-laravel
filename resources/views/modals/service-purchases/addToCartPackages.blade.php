                        ...
                        <table style="table-layout: fixed;">
                            ...
                            <tbody>
                                <tr ng-repeat='service in packageToAdd.serviceList'>
                                    ...
                                    <td>
                                        <center>
                                            <a ng-show='service.intServiceType == 1' ng-click='scheduleService(service)' data-target="scheduleService" tooltipped class="btn-floating waves-light btn @{{ service.scheduleColor }} modal-trigger" data-position="bottom" data-delay="50" data-tooltip="Schedule" 
                                            href="#scheduleService"><i class="material-icons" style = "color: #000000;">alarm_on</i></a>
                                            <a ng-show='service.deceasedForm' ng-click='addDeceasedForm(service)' data-target="deceasedForm" tooltipped class="btn-floating waves-light btn @{{ service.deceasedColor }} modal-trigger" href="#deceasedForm" data-position="bottom" data-delay="50" data-tooltip="Edit Deceased Form" style="clear:bottom;"><i class="material-icons" style = "color: #000000;">assignment_ind</i></a>
                                            <a ng-show='service.unitForm' data-target="unitForm" tooltipped class="btn-floating waves-light btn light-green modal-trigger" href="#unitForm" data-position="bottom" data-delay="50" data-tooltip="Edit Unit Form" style="clear:bottom;"><i class="material-icons" style = "color: #000000;">dashboard</i></a>
                                        </center>
                                    </td>
                                </tr>
                            </tbody>
