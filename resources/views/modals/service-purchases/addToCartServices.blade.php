                                ...
                                <tr ng-repeat='service in serviceScheduleToAdd'>
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <a ng-show='serviceToAdd.intServiceForm == 2' data-target="unitForm" tooltipped class="btn-floating waves-light btn light-green modal-trigger" href="#unitForm" data-position="bottom" data-delay="50" data-tooltip="Edit Unit Form" style="clear:bottom;"><i class="material-icons" style = "color: #000000;">dashboard</i></a>
                                        </center>
                                    </td>
                                </tr>
                            </tbody>
