                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li style = "margin-top: -8px; max-height: 40px;"><a href="{!! url('/room') !!}"><h6 style = "font-size: 15px; font-family: myFirstFont2; padding-top: 10px;">Room</h6></a></li>
                                    ...
                                    <li style = "margin-top: -8px; max-height: 40px;"><a href="{!! url('/additionals') !!}"><h6 style = "font-size: 15px; font-family: myFirstFont2; padding-top: 10px;">Additionals</h6></a></li>
