                    ...
                    {{--<li>--}}
                        ...
                        {{--<div class="collapsible-body">--}}
                            {{--<ul>--}}
                                ...
                                {{--<li style = "margin-top: -8px; max-height: 40px;"><a href="{!! url('/floor-maintenance') !!}"><h6 style = "font-size: 15px; font-family: myFirstFont2; padding-top: 10px;">Floor</h6></a></li>--}}
                                ...
                                {{--<li style = "margin-top: -8px; max-height: 40px;"><a href="{!! urL('/unit-maintenance') !!}"><h6 style = "font-size: 15px; font-family: myFirstFont2; padding-top: 10px;">Unit</h6></a></li>--}}
