...
@section('body')
    ...
    <div class = "s12 m12 l12" ng-controller="ctrl.utilities">
        <div class = "s12 m6 l5 center formCreate aside aside z-depth-3" id="formCreate" style = "height: 520px; margin-top: 20px; width: 1340px; margin-left: 15px;">
