                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ collectionActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/collection-downpayment-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">COLLECTION REPORT</h6></a></li>
