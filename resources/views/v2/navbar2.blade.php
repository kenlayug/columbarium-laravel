            ...
            <nav id="slide-out-l" class="side-nav left" style = "background-color: #212121;">
                ...
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ collectionActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/collection-downpayment-transaction') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">COLLECTION</h6></a></li>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li class="@{{ unitPurchaseActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/sales-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">SALES REPORT</h6></a></li>
                                <li class="@{{ unitPurchaseActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/unit-purchases-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">UNIT PURCHASES</h6></a></li>
                                <li class="@{{ collectionActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/collection-downpayment-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">COLLECTION AND DOWNPAYMENT</h6></a></li>
                                ...
                                <li class="@{{ assignSchedActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/assign-schedule-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">LIST OF SCHEDULE</h6></a></li>
                                ...
                                <li class="@{{ unitPurchaseActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/overview-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">OVERVIEW REPORT</h6></a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
