                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ packageActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/discount-maintenance') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">DISCOUNT</h6></a></li>
                                <li class="@{{ packageActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/assign-discount-maintenance') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">ASSIGN DISCOUNT</h6></a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ unitReportActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/unit-purchases-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">UNIT PURCHASES</h6></a></li>
