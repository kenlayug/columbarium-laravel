                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ buildingQueryActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/building-query') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">BUILDING</h6></a></li>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="@{{ servicePurchaseActive }}" style = "margin-top: -8px; max-height: 40px;"><a style = "padding-left: 60px; margin-left: 0px; width: 100%;" href="{!! url('/service-purchases-report') !!}"><h6 style = "font-size: 15px; font-family: roboto2; padding-top: 10px;">SERVICE PURCHASES</h6></a></li>
