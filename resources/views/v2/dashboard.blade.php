            ...
            <div class="row">
                <div class="col s12 m12 l4" style = "margin-top: -8px;" ng-controller="ctrl.notification">
                    ...
                    <ul id="task-card" class="collection with-header" style = "margin-top: -15px; overflow-y: auto; height: 363px;">
                        ...
                        <li class="collection-item dismissable" style = "height: 65px;">
                            <div class = "row">
                                <div class = "col s10" style = "margin-left: -20px;">
                                    <a name = "action" class="btn-floating red" style = "margin-top: 0px; margin-left: -10px;"><i class="material-icons" style = "color: black;" ng-bind="notificationIconList[1]"></i></a>
                                    <u>
                                        <label for="task1" style = "font-weight: bold; margin-top: -40px; margin-left: 40px; font-size: 15px;" ng-bind="notificationTypeList[1]"></label>
                                    </u>
