                    ...
                    <div class="card">
                        <div class="card-move-up waves-effect waves-block waves-light">
                            <div class="move-up blue-grey darken-1">
                                ...
                                <div class = "teal col s12 m6 l12" id = "hiddenWeeklyStatistics" style = "margin-bottom: 25px; margin-top: -20px; height: 270px;">
                                    <div id="stackedWeeklyStatisticalGraph" style="min-width: 96.5%; height: 250px; padding-top: 20px;"></div>
                                </div>
                            </div>
                        </div>
